...
- **Core Engine**: [React 19](https://react.dev/) (utilizing latest features like `useActionState` and modern Concurrent Rendering).
- **Styling**: [Tailwind CSS v4](https://tailwindcss.com/) — Next-generation engine with zero-runtime overhead and 100% CSS variable-driven configuration.
