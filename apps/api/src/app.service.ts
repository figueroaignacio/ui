...
export class AppService {
  getWelcomeMessage() {
    return {
      title: 'MATE UI REGISTRY API',
      version: '1.0.0',
      tagline: 'The kernel of your Frontend',
      quote: 'If you think your UI is good, you are probably wrong. Like me',
      message:
        "Welcome to the source of truth. Mate UI is NOT a library for weak developers who love 1GB of node_modules. It's for people who know how to copy-paste code and OWN IT.",
      endpoints: [
        '/api/v1',
        '/api/v1/health',
        '/api/v1/inspiration',
  ...
  getSecretQuote(): string {
    const quotes = [
      ...
      'Most decorators are just a way to hide bad architecture. Use Mate UI instead.',
      "Real developers don't need 'npm install'. They need a CLI and a dream.",
      "If it compiles, it's good. If it has Mate UI, it's perfect.",
    ];
