...
export function DocsPagination({ currentPath }: DocsPaginationProps) {
  ...
  return (
    <div className="border-border mt-12 flex items-center justify-between gap-4 border-t pt-8">
      {prev ? (
        <Link
          href={prev.href}
          className="border-border hover:bg-accent bg-card group flex flex-1 flex-col gap-2 rounded-lg border p-4 transition-colors"
        >
      ...
      {next ? (
        <Link
          href={next.href}
          className="border-border hover:bg-accent bg-card group flex flex-1 flex-col gap-2 rounded-lg border p-4 text-right transition-colors"
        >
