...
const headingStyles = {
  ...
  h2: 'font-heading mt-12 scroll-m-20 text-2xl font-semibold tracking-tight transition-colors first:mt-0',
  h3: 'font-heading mt-12 mb-5 scroll-m-20 text-lg font-semibold tracking-tight text-muted-foreground',
