---
title: Introduction
description: Welcome to the official Mate UI documentation.
published: true
toc:
  visible: true
date: 2024-03-14
...
<Callout variant="info" className="mb-4">
  ...
  <Callout.Content>
    Mate UI is not just a set of components. It is your own Design System—open, transparent, and
...
Mate UI is an **independent project** developed from the ground up by **Ignacio "Nacho" Figueroa**. It's not backed by a large company or team—it's a personal endeavor driven by a passion for creating accessible, beautiful, and truly open design systems.

**Inspired by the best:**

Mate UI draws inspiration from exceptional projects in the ecosystem:

- **[shadcn/ui](https://ui.shadcn.com/)** — For pioneering the "copy-paste components" philosophy and proving that developers want ownership over their code
- **[Base UI](https://base-ui.com/)** — For demonstrating how unstyled, accessible primitives can empower developers
- **[Hero UI](https://heroui.com/)** — For showing how modern design systems can be both beautiful and functional

While inspired by these projects, Mate UI is built **entirely from scratch** with its own vision: a design system that's not just open source, but truly **open code**—where every component, token, and pattern is yours to own, modify, and extend without limits.
...
Mate UI removes that pain by giving you **the actual source code**, along with **design tokens** and design patterns you can extend without limits.
...
When you add a component from Mate UI, the source code becomes part of your project.
...
Mate UI defines a solid foundation of **design tokens**, composition patterns, and visual rules that apply across the system.
...
Mate UI embraces the **Compound Component** pattern to provide maximum flexibility and highly readable, intuitive APIs.
...
Mate UI includes a system designed to scale with your projects:
...
Mate UI is built for the era of assisted development:
