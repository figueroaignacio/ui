...
<AccordionItem value="faq-3">
  ...
  <AccordionContent>
    Yes, absolutely. I7A UI is completely free and open source. You can use it in personal,
...
<AccordionItem value="faq-5">
  ...
  <AccordionContent>
    No. I7A UI comes with a complete and coherent design system ready to use. Design tokens, colors,
...
<AccordionItem value="faq-7">
  ...
  <AccordionContent>
    I7A UI is designed with AI in mind. Being open source and completely visible: - AIs can read and
