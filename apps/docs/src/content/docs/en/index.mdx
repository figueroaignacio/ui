---
title: Introduction
description: Welcome to the official MateUI documentation.
published: true
toc:
  visible: true
date: 2024-03-14
...
<Callout variant="info" className="mb-4">
  ...
  <Callout.Content>
    MateUI is not just a set of components. It is your own Design System—open, transparent, and
...
MateUI is an **independent project** developed from the ground up by **Ignacio "Nacho" Figueroa**. It's not backed by a large company or team—it's a personal endeavor driven by a passion for creating accessible, beautiful, and truly open design systems.

**Inspired by the best:**

MateUI draws inspiration from exceptional projects in the ecosystem:
...
While inspired by these projects, MateUI is built **entirely from scratch** with its own vision: a design system that's not just open source, but truly **open code**—where every component, token, and pattern is yours to own, modify, and extend without limits.
...
MateUI removes that pain by giving you **the actual source code**, along with **design tokens** and design patterns you can extend without limits.
...
When you add a component from MateUI, the source code becomes part of your project.
...
MateUI defines a solid foundation of **design tokens**, composition patterns, and visual rules that apply across the system.
...
MateUI embraces the **Compound Component** pattern to provide maximum flexibility and highly readable, intuitive APIs.
...
MateUI includes a system designed to scale with your projects:
...
MateUI is built for the era of assisted development:
