...
<Accordion type="multiple" className="mt-6" defaultValue="faq-1">
  <AccordionItem value="faq-1">
    <AccordionTrigger>Is I7A UI an npm library?</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="faq-2">
    <AccordionTrigger>What makes I7A UI different from other component libraries?</AccordionTrigger>
    <AccordionContent>
      Unlike libraries like MUI or Ant Design that work as black boxes, I7A UI delivers the complete source code. This means:
  ...
  <AccordionItem value="faq-3">
    <AccordionTrigger>Can I use I7A UI in commercial projects?</AccordionTrigger>
    <AccordionContent>
      Yes, absolutely. I7A UI is completely free and open source. You can use it in personal, commercial, client projects, or any other type without restrictions. The code is yours once you copy it to your project.
    </AccordionContent>
  </AccordionItem>
  ...
  <AccordionItem value="faq-5">
    <AccordionTrigger>Do I need design knowledge to use I7A UI?</AccordionTrigger>
    <AccordionContent>
      No. I7A UI comes with a complete and coherent design system ready to use. Design tokens, colors, spacing, and components are already professionally designed. You can use them as they are or customize them according to your needs.
    </AccordionContent>
  </AccordionItem>

  <AccordionItem value="faq-6">
    <AccordionTrigger>Does I7A UI work with Next.js, Remix, Vite?</AccordionTrigger>
    <AccordionContent>
      Yes. I7A UI is built with React and works with any modern framework that supports it:
  ...
  <AccordionItem value="faq-7">
    ...
    <AccordionContent>
      I7A UI is designed with AI in mind. Being open source and completely visible:
     
      - AIs can read and understand the entire implementation
      - They can suggest modifications based on your actual code
      - They can generate new components following your existing patterns
      - There are no "black boxes" that confuse models
    
      It's the future of development: humans and AI working on the same code.
    </AccordionContent>
  </AccordionItem>
  ...
  <AccordionItem value="faq-8">
    ...
    <AccordionContent>
      Yes. All I7A UI components are designed following WCAG and WAI-ARIA guidelines:
