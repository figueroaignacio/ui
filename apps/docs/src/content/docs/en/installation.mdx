---
title: Installation
description: How to get started with Mate UI in your project.
published: true
date: 2025-10-22
locale: en
toc:
...
Mate UI requires the following libraries to work properly:
...
This function is used by all Mate UI components to intelligently merge Tailwind classes.
...
Here's the recommended folder structure for organizing Mate UI components in your project:
...
- `components/ui/` - Mate UI components (copied from docs)
