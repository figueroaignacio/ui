---
title: Instalación
description: Cómo empezar a usar Mate UI en tu proyecto.
published: true
date: 2025-10-22
locale: es
toc:
...
Mate UI requiere las siguientes librerías para funcionar correctamente:
...
Esta función es utilizada por todos los componentes de Mate UI para fusionar clases de Tailwind de manera inteligente.
...
Aquí está la estructura de carpetas recomendada para organizar los componentes de Mate UI en tu proyecto:
...
- `components/ui/` - Componentes de Mate UI (copiados de los docs)
