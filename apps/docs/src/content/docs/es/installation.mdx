---
title: Instalación
description: Cómo empezar a usar NachUI en tu proyecto.
published: true
date: 2025-10-22
locale: es
toc:
...
<Callout title="Requisitos previos" variant="info">
...
- `app/` - Tus páginas y layouts de Next.js
...
- Revisa los [ejemplos](/examples) para ver casos de uso reales
