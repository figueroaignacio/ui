...
<Callout title="Info" variant="info">
  <p className="mb-3">
    NachUI no es solo un conjunto de componentes. Es tu propio sistema de diseño, abierto,
    transparente y completamente bajo tu control.
  </p>
  <p>
    A diferencia de las bibliotecas tradicionales que dependen de paquetes cerrados o abstracciones
    internas, NachUI es **Open Source** y **Open Code**. Eso significa que el código es tuyo desde
    el primer instante: visible, editable y sin barreras artificiales.
  </p>
</Callout>
...
InclAnatomía las integraciones externas se adaptan al mismo lenguaje visual, garantizando cohesión en toda tu interfaz.
