...
<Callout variant="info">
  ...
  <Callout.Content>
    ...
    <p>
      A diferencia de las bibliotecas tradicionales que dependen de paquetes cerrados o
      abstracciones internas, NachUI es **Open Source** y **Open Code**. Eso significa que el código
      es tuyo desde el primer instante: visible, editable y sin barreras artificiales.
    </p>
  </Callout.Content>
</Callout>
