...
<PackageManagerTabs command="install nach-themes" />
...
Obtén el tema real que se está aplicando, inclAnatomía cuando está configurado en `'system'`:
