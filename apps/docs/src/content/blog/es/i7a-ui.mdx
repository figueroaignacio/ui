...
MateUI no quiere ser “la próxima gran librería”.  
...
MateUI es mi forma de crear un sistema de diseño real, flexible, accesible y totalmente abierto.
