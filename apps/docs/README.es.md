# Documentación de MateUI (Web)

[English](./README.md) | [Español]

La interfaz principal y el Portal de Documentación Neural para el ecosistema MateUI. Una aplicación **Next.js** de alto rendimiento que sirve como galería interactiva de componentes y motor para desarrolladores.
...
Cada componente en MateUI se renderiza dentro de un entorno simulado, lo que permite a los desarrolladores interactuar, probar y extraer el código fuente en milisegundos.
